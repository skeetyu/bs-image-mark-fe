<template>
    <div>
        ...
        <el-dialog :visible.sync="ifShown" :title="shownTask" width="800px" top="150px" :before-close="closeShown">
            ...
            <span>
                ...
                <el-button type="primary" size="medium" v-on:click="gotoShowMark">查看</el-button>
            </span>
            </template>
        </el-dialog>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            gotoShowMark(){
                this.$router.replace({name: 'Workbench', params: {graph: this.checkList, task: this.shownTask, ifMarked: 1}})
            }
        }
    }
</script>
